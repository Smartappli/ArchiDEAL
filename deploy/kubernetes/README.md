...
50 items, and a running operation beyond the reconciliation timeout margin or with an unrecovered
lease. Follow `docs/runbooks/observability-alerts.md`; never delete or edit durable operation rows
to clear an alert.
